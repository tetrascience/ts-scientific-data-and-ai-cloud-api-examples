# ts-scientific-data-and-ai-cloud-api-examples
TetraScience Scientific Data and AI Cloud API Usage Examples

## Getting started

* Install Python 3.10 or higher (We recommend using pyenv if you have to work with multiple versions on the same machine.)
...
* [Querying Empower Data](https://github.com/tetrascience/ts-scientific-data-cloud-api-examples/blob/main/examples/Querying%20Empower%20Data.ipynb)
